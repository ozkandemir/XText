		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProductUnitAccess().getOperationUnitsAssignment_3(), "rule__ProductUnit__OperationUnitsAssignment_3");
					...
					put(grammarAccess.getOperationUnitAccess().getStatementsAssignment_5(), "rule__OperationUnit__StatementsAssignment_5");
					...
					put(grammarAccess.getControlStatementElementAccess().getErrorAssignment_1(), "rule__ControlStatementElement__ErrorAssignment_1");
