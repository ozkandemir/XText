 ...
 * <ul>
 *   <li>{@link com.ykb.umap.dsl.product.EDataType#getName <em>Name</em>}</li>
 *   <li>{@link com.ykb.umap.dsl.product.EDataType#getParameters <em>Parameters</em>}</li>
 *   <li>{@link com.ykb.umap.dsl.product.EDataType#getOperationUnits <em>Operation Units</em>}</li>
 * </ul>
 * </p>
 *
 * @see com.ykb.umap.dsl.product.ProductPackage#getEDataType()
 * @model
 * @generated
 */
public interface EDataType extends EObject
{
   ...
   * @see #setName(String)
   * @see com.ykb.umap.dsl.product.ProductPackage#getEDataType_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link com.ykb.umap.dsl.product.EDataType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see com.ykb.umap.dsl.product.ProductPackage#getEDataType_Parameters()
   ...
   * @see com.ykb.umap.dsl.product.ProductPackage#getEDataType_OperationUnits()
   * @model containment="true"
   * @generated
   */
