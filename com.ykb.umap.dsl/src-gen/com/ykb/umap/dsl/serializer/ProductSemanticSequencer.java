...
public class ProductSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ProductPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case ProductPackage.ESTATEMENT:
				if(context == grammarAccess.getStatementRule()) {
					sequence_Statement(context, (EStatement) semanticObject); 
					return; 
				}
				else break;
	...
	protected void sequence_ControlStatementElement(EObject context, EControlStatementElement semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ProductPackage.Literals.ECONTROL_STATEMENT_ELEMENT__ERROR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ProductPackage.Literals.ECONTROL_STATEMENT_ELEMENT__ERROR));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
	...
	/**
	 * Constraint:
	 *     (name=ID controls+=ControlElement* statements+=Statement*)
	 */
	...
	protected void sequence_Statement(EObject context, EStatement semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, ProductPackage.Literals.ESTATEMENT__STATEMENT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, ProductPackage.Literals.ESTATEMENT__STATEMENT));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
